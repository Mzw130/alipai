...
export default function HDReshapeScreen() {
  ...
  return (
    <SafeAreaView style={s.c}>
      <View style={s.h}><TouchableOpacity onPress={()=>n.goBack()}><Ionicons name="chevron-back" size={24} color={Colors.text} /></TouchableOpacity><View style={s.hc}><Text style={s.ht}>重塑</Text><Text style={s.hs}>Reshape</Text></View><View style={{width:24}} /></View>
      <ScrollView contentContainerStyle={s.ct}>
        ...
        {!resultUrl && <View style={s.dc}><Ionicons name="body" size={24} color={Colors.primary} /><View style={{flex:1}}><Text style={s.dt}>重塑塑形</Text><Text style={s.de}>AI 智能调整身体轮廓与线条</Text></View></View>}
