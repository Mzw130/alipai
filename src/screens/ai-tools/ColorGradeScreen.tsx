    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>调色</Text>
          <Text style={styles.headerSub}>Color Grade</Text>
        </View>
        <View style={{ width: 24 }} />
      </View>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.descCard}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.descTitle}>调色</Text>
            <Text style={styles.descText}>AI 智能调色，电影级色彩</Text>
          </View>
        </View>
