    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>丰唇</Text>
          <Text style={styles.headerSub}>Lip Plump</Text>
        </View>
        <View style={{ width: 24 }} />
      </View>
      <ScrollView contentContainerStyle={styles.content}>
        <TouchableOpacity style={styles.imageArea} activeOpacity={0.7}>
          ...
          <Text style={styles.uploadSub}>从相册选取面部照片</Text>
        </TouchableOpacity>
        <View style={styles.descCard}>
          <Ionicons name="rose" size={24} color={Colors.primary} />
          <View style={{ flex: 1 }}>
            <Text style={styles.descTitle}>饱满嘴唇效果</Text>
            <Text style={styles.descText}>AI 智能识别唇形，自然丰唇</Text>
          </View>
        </View>
