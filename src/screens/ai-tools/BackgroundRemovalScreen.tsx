    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>去背景</Text>
          <Text style={styles.headerSub}>Background Removal</Text>
        </View>
        <View style={{ width: 24 }} />
      </View>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.descCard}>
          ...
          <Text style={styles.descText}>一键去除图片背景，AI 智能识别主体</Text>
        </View>
        <TouchableOpacity style={styles.generateBtn} onPress={() => setShowAuth(true)} activeOpacity={0.8}>
          ...
          <Text style={styles.generateText}>去背景</Text>
        </TouchableOpacity>
      </ScrollView>
