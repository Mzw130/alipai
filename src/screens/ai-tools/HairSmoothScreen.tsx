    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>顺滑秀发</Text>
          <Text style={styles.headerSub}>Hair Smoothing</Text>
        </View>
        <View style={{ width: 24 }} />
      </View>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.descCard}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.descTitle}>丝滑秀发效果</Text>
            <Text style={styles.descText}>AI 智能柔顺发丝，打造丝滑质感</Text>
          </View>
        </View>
