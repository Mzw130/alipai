    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerCenter}>
          <Text style={styles.headerTitle}>精致下颌线</Text>
          <Text style={styles.headerSub}>Jawline Contour</Text>
        </View>
        <View style={{ width: 24 }} />
      </View>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.descCard}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.descTitle}>下巴轮廓优化</Text>
            <Text style={styles.descText}>AI 智能塑形，精致下颌线条</Text>
          </View>
        </View>
